...
## Return Values
### System.Collections.Generic.Dictionary[String,String]<br>   Set-AcctIdentityPoolMetadata returns a dictionary containing the new (name, value)-pairs.<br>    Key <string><br>        Specifies the name of the property.<br>    Value <string><br>        Specifies the value for the property.
   ## Notes
...
c:\PS>Set-AcctIdentityPoolMetadata -IdentityPoolUid 4CECC26E-48E1-423F-A1F0-2A06DDD0805C -Name property -Value value
          ...
          property                                  value
```
   Description<br>-----------<br>Add metadata with a name of 'property' and a value of 'value' to the IdentityPool with the identifier '4CECC26E-48E1-423F-A1F0-2A06DDD0805C'.
