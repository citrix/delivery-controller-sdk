...
## Syntax
```
Get-AppLibDBVersionChangeScript -DatabaseName <String> -TargetVersion <Version> [-AdminAddress <String>] [<CommonParameters>]
```
...
## Related Commands
  * [Get-AppLibInstalledDBVersion](Get-AppLibInstalledDBVersion.html)
