...
## Syntax
```
Get-AppLibServiceAddedCapability [-AdminAddress <String>] [<CommonParameters>]
```
...
### EXAMPLE 1
```
C:\PS>Get-AppLibServiceAddedCapability
```
   Description<br>-----------<br>Get the added capabilities of the AppLibrary Service.
