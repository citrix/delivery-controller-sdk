...
## Return Values
### System.Version
   Get-BrokerInstalledDBVersion returns database schema version numbers as requested.## Notes
...
```
   Description<br>-----------<br>Gets the current Citrix Broker Service database schema version number.
### EXAMPLE 2
```
C:\PS>Get-BrokerInstalledDBVersion -Upgrade
```
   Description<br>-----------<br>Get the versions of the Broker Service database schema for which upgrade scripts are supplied.
