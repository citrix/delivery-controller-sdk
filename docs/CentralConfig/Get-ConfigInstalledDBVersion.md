...
## Syntax
```
Get-ConfigInstalledDBVersion [-Upgrade] [-Downgrade] [-BearerToken <String>] [-AdminAddress <String>] [<CommonParameters>]
```
...
## Related Commands
  * [Get-ConfigDBVersionChangeScript](Get-ConfigDBVersionChangeScript.html)
...
## Return Values
### System.Version
   Get-ConfigInstalledDBVersion returns database schema version numbers as requested.<br>Major <Integer> Minor <Integer> Build <Integer> Revision <Integer>## Notes
...
### EXAMPLE 1
```
PS C:\>Get-ConfigInstalledDBVersion

Major  Minor  Build  Revision
-----  -----  -----  --------
5      6      0      0
```
   Description<br>-----------<br>Gets the current Citrix Configuration Service database schema version number.
### EXAMPLE 2
```
C:\PS>Get-ConfigInstalledDBVersion -Upgrade
```
   Description<br>-----------<br>Get the versions of the Configuration Service database schema for which upgrade scripts are supplied.
