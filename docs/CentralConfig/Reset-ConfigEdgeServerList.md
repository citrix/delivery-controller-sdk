...
## Syntax
```
Reset-ConfigEdgeServerList [-AdminAddress <String>] [<CommonParameters>]
```
...
### EXAMPLE 1
```
c:\PS>Reset-ConfigEdgeServerList
```
   Description<br>-----------<br>Refresh the internal list of Edge Servers.
