...
## Syntax
```
Get-LogServiceAddedCapability [-BearerToken <String>] [-AdminAddress <String>] [<CommonParameters>]
```
...
```
   Description<br>-----------<br>Get the added capabilities of the ConfigurationLogging Service.
