...
```
#### Description
Gets a script to create the full database schema for the Citrix Configuration Service and copies it to a file called "C:\\ConfigurationSchema.sql"&lt;br&gt;This script can be used to create the service schema in a database with name "MySiteDB", which must already exist, and must not already contain a Configuration service schema.
### Example 2
```
