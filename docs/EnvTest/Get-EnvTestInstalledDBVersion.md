...
## Return Values
### System.Version
   Get-EnvTestInstalledDBVersion returns database schema version numbers as requested.<br>Major <Integer> Minor <Integer> Build <Integer> Revision <Integer>## Notes
...
### EXAMPLE 1
```
PS C:\>Get-EnvTestInstalledDBVersion

Major  Minor  Build  Revision
-----  -----  -----  --------
5      6      0      0
```
   Description<br>-----------<br>Gets the current Citrix EnvTest Service database schema version number.
### EXAMPLE 2
```
C:\PS>Get-EnvTestInstalledDBVersion -Upgrade
```
   Description<br>-----------<br>Get the versions of the EnvTest Service database schema for which upgrade scripts are supplied.
