...
## Return Values
### System.Collections.Generic.Dictionary[String,String]<br>   Set-EnvTestServiceMetadata returns a dictionary containing the new (name, value)-pairs.<br>    Key <string><br>        Specifies the name of the property.<br>    Value <string><br>        Specifies the value for the property.
   ## Notes
