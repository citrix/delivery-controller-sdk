...
## Syntax
```
Get-OrchService [-Metadata <String>] [-Property <String[]>] [-ReturnTotalRecordCount] [-MaxRecordCount <Int32>] [-Skip <Int32>] [-SortBy <String>] [-Filter <String>] [-AdminAddress <String>] [<CommonParameters>]
```
...
RestApiEnabled     : True
```
   Description<br>-----------<br>Get all the instances of the Orchestration Service running in the current service group.
