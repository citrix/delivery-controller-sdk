...
## Syntax
```
Get-OrchServiceAddedCapability [-AdminAddress <String>] [<CommonParameters>]
```
...
### EXAMPLE 1
```
C:\PS>Get-OrchServiceAddedCapability
```
   Description<br>-----------<br>Get the added capabilities of the Orchestration Service.
