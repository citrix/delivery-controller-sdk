...
## Syntax
```
Get-OrchServiceInstance [-AdminAddress <String>] [<CommonParameters>]
```
...
### EXAMPLE 1
```
c:\PS>Get-OrchServiceInstance

Address            : http://MyServer.com:80/Citrix/Orchestration/PowerShellSdk
...
Address            : http://MyServer.com:80/Citrix/Orchestration/OrchestrationApi
Binding            : wcf_HTTP_kerb
