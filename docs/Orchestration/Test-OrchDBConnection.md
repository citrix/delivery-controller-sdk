...
## Syntax
```
Test-OrchDBConnection [-DBConnection] <String> [-LoggingId <Guid>] [-AdminAddress <String>] [<CommonParameters>]
```
...
```
   Description<br>-----------<br>Tests an invalid database connection string for the Orchestration Service.
