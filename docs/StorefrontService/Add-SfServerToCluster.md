...
| XmlServices | Collection of the url of xml services that will be used inside a farm. The URLs need to be http or https, be absolute and share the same schema and port.  Either both FarmName and XmlServices need to be specified or none of them. | false | false |  |
