...
## Syntax
```
Get-SfServiceAddedCapability [-BearerToken <String>] [-AdminAddress <String>] [<CommonParameters>]
```
...
```
   Description<br>-----------<br>Get the added capabilities of the Storefront Service.
